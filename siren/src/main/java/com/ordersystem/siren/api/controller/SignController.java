...
public class SignController {
    ...
    public ResponseEntity<?> signup(@ApiParam @Valid @RequestBody UserRequestDto.SignUp signUp, Errors errors){
        ...
        UserResponseDto.UserDto userDto = new UserResponseDto.UserDto(userService.join(signUp));
        return response.success(userDto,"Sign up success.",HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> refresh(@Valid @RequestBody UserRequestDto.NewToken newToken, Errors errors){
        ...
        UserResponseDto.TokenDto tokenDto = new UserResponseDto.TokenDto(userService.reGenerateToken(auth, newToken));
        return response.success(tokenDto, "Regenerated token.", HttpStatus.OK);
    }
}
